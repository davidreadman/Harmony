...
public class HarmonyEngine {
    ...
    public HarmonyEngine(NodeData[] nodeData) {
    ...
    public void detectNodes() {
        for(int i=0;i<nodes.size();i++) {
            ...
            for(int j=0;j<nodes.size();j++) {
                ...
                Distance distanceFromNode = Distance.fromMiles(Position.greatCircleDistance(currentNode.currentLocation, nodes.get(j).currentLocation).radians * MovementDecision.tempGlobe.getRadius());
