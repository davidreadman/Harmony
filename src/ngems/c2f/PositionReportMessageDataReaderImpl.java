...
public class PositionReportMessageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements PositionReportMessageDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private PositionReportMessageTypeSupport typeSupport;

    public PositionReportMessageDataReaderImpl(ngems.c2f.PositionReportMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new PositionReportMessageDataReaderViewImpl(typeSupport);
    }
}
