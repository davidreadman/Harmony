...
public class TextMessageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements TextMessageDataReaderView
{
    ...
    public TextMessageDataReaderViewImpl(ngems.c2f.TextMessageTypeSupport ts)
    {
        typeSupport = ts;
