...
public class HeartbeatMessageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements HeartbeatMessageDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private HeartbeatMessageTypeSupport typeSupport;

    public HeartbeatMessageDataReaderImpl(ngems.c2f.HeartbeatMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new HeartbeatMessageDataReaderViewImpl(typeSupport);
    }
}
