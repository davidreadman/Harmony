...
public class PointOfInterestMessageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements PointOfInterestMessageDataReaderView
{
    ...
    public PointOfInterestMessageDataReaderViewImpl(ngems.c2f.PointOfInterestMessageTypeSupport ts)
    {
        typeSupport = ts;
