...
public class HeartbeatMessageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements HeartbeatMessageDataReaderView
{
    ...
    public HeartbeatMessageDataReaderViewImpl(ngems.c2f.HeartbeatMessageTypeSupport ts)
    {
        typeSupport = ts;
