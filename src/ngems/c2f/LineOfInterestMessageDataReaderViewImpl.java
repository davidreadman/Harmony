...
public class LineOfInterestMessageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements LineOfInterestMessageDataReaderView
{
    ...
    public LineOfInterestMessageDataReaderViewImpl(ngems.c2f.LineOfInterestMessageTypeSupport ts)
    {
        typeSupport = ts;
