...
public class PointOfInterestMessageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements PointOfInterestMessageDataWriter
{
    ...
    public PointOfInterestMessageDataWriterImpl(ngems.c2f.PointOfInterestMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            ngems.c2f.PointOfInterestMessage instance_data)
    {
        long uWriter = 0;
