...
public class HeartbeatMessageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements HeartbeatMessageDataWriter
{
    ...
    public HeartbeatMessageDataWriterImpl(ngems.c2f.HeartbeatMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            ngems.c2f.HeartbeatMessage instance_data)
    {
        long uWriter = 0;
