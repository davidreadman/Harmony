...
public class PositionReportMessageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements PositionReportMessageDataReaderView
{
    ...
    public PositionReportMessageDataReaderViewImpl(ngems.c2f.PositionReportMessageTypeSupport ts)
    {
        typeSupport = ts;
