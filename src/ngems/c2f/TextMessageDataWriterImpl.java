...
public class TextMessageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements TextMessageDataWriter
{
    ...
    public TextMessageDataWriterImpl(ngems.c2f.TextMessageTypeSupport ts)
    {
        typeSupport = ts;
