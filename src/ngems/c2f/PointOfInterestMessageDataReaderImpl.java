...
public class PointOfInterestMessageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements PointOfInterestMessageDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private PointOfInterestMessageTypeSupport typeSupport;

    public PointOfInterestMessageDataReaderImpl(ngems.c2f.PointOfInterestMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new PointOfInterestMessageDataReaderViewImpl(typeSupport);
    }
}
