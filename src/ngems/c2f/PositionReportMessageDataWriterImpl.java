...
public class PositionReportMessageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements PositionReportMessageDataWriter
{
    ...
    public PositionReportMessageDataWriterImpl(ngems.c2f.PositionReportMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            ngems.c2f.PositionReportMessage instance_data)
    {
        long uWriter = 0;
