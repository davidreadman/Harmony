...
public class LineOfInterestMessageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements LineOfInterestMessageDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private LineOfInterestMessageTypeSupport typeSupport;

    public LineOfInterestMessageDataReaderImpl(ngems.c2f.LineOfInterestMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            ngems.c2f.LineOfInterestMessageSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            ngems.c2f.LineOfInterestMessageHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            ngems.c2f.LineOfInterestMessageHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        ngems.c2f.LineOfInterestMessage instance)
    {
        long uReader = 0;
    ...
    {
        return new LineOfInterestMessageDataReaderViewImpl(typeSupport);
    }
}
