...
public class TextMessageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements TextMessageDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private TextMessageTypeSupport typeSupport;

    public TextMessageDataReaderImpl(ngems.c2f.TextMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    */
    ...
    {
        return new TextMessageDataReaderViewImpl(typeSupport);
    }
}
