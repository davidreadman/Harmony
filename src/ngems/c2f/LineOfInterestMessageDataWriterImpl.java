...
public class LineOfInterestMessageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements LineOfInterestMessageDataWriter
{
    ...
    public LineOfInterestMessageDataWriterImpl(ngems.c2f.LineOfInterestMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    public long register_instance(
            ngems.c2f.LineOfInterestMessage instance_data)
    {
        long uWriter = 0;
